...
function random_code() {
    ...
    let generated_code = `${digit01}${digit02}${digit03}${digit04}${digit05}${digit06}`;

    // Display the randomly generated number
    document.getElementById("authenticator_code").innerText = generated_code;
}

// Create a function that counts down the seconds till the next number is generated
function countdown() {
...
function authenticate() {
    ...
    let authenticator_form = document.getElementById("authenticator_form").value;   

    // Compare the user's input with the number generated by the 2FA
    if (authenticator_form == generated_code) {
